function [fitting, gof] = FitDetrimentalToDetrimental(T, Tp, repeat)
    ...
    functionLS = ['DetrimentalToDetrimental(mutation_rate_a, fitness_a, '...
    ...
    options = fitoptions('method', 'NonlinearLeastSquares', 'Robust', 'on', ...
        ...
        'Upper', [2.5e-4 2.5e-4 1.6 0.999 0.999], 'TolX', 1e-8, 'TolFun', 1e-8, ...
        'Startpoint', [1e-5 1e-6 1.25 0.8 0.8]);
