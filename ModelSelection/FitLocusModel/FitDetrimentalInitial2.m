function [fitting, gof] = FitDetrimentalInitial2(T, Tp, repeat)
    ...
    functionLS = ['DetrimentalInitial2(mutation_rate_a, fitness_a, '...
        'mutation_rate_b, fitness_b, initial2, x)'];
    ...
    options = fitoptions('method', 'NonlinearLeastSquares', 'Robust', 'on', ...
        'MaxIter', 1000, 'Lower', [1e-5 1e-6 1.25 0 0], ...
        'Upper', [2.5e-4 2.5e-4 1.6 0.999 0.01], 'TolX', 1e-8, 'TolFun', 1e-8, ...
        'Startpoint', [1e-5 1e-6 1.25 0.8 0]);
