function [fitting, gof] = FitDetrimentalDelay(T, Tp, repeat)
    ...
    functionLS = ['DetrimentalDelay(mutation_rate_a, fitness_a, '...
    ...
    options = fitoptions('method', 'NonlinearLeastSquares', 'Robust', 'on', ...
        ...
        'Upper', [2.5e-4 2.5e-4 1.6 0.999 60], 'TolX', 1e-8, 'TolFun', 1e-8, ...
