function [fitting, gof] = FitNeutralDelay(T, Tp, repeat)
    ...
    functionLS = ['NeutralDelay(mutation_rate_a, fitness_a, '...
        'mutation_rate_b, delay, x)'];
    ...
    options = fitoptions('method', 'NonlinearLeastSquares', 'Robust', 'on', ...
        ...
        'Upper', [2.5e-4 2.5e-4 1.6 60], 'TolX', 1e-8, 'TolFun', 1e-8, ...
