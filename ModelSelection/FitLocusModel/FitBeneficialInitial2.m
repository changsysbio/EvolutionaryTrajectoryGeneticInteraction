function [fitting, gof] = FitBeneficialInitial2(T, Tp, repeat)
    ...
    functionLS = ['BeneficialInitial2(mutation_rate_a, fitness_a, '...
    ...
    options = fitoptions('method', 'NonlinearLeastSquares', 'Robust', 'on', ...
        ...
        'Upper', [2.5e-4 2.5e-4 1.6 1.6 0.01], 'TolX', 1e-8, 'TolFun', 1e-8, ...
