function [fitting, gof] = FitBeneficialToBeneficial(T, Tp, repeat)
    ...
    functionLS = ['BeneficialToBeneficial(mutation_rate_a, fitness_a, '...
    ...
    options = fitoptions('method', 'NonlinearLeastSquares', 'Robust', 'on', ...
        'MaxIter', 1000, 'Lower',[1e-5 1e-6 1.25 1.001 1.001], ...
        'Upper', [2.5e-4 2.5e-4 1.6 1.6 1.6], 'TolX', 1e-8, 'TolFun', 1e-8, ...
        'Startpoint', [1e-5 1e-6 1.25 1.05 1.05]);
